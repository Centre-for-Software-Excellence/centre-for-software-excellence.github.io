...
**The Problem:** _Training software engineering (SWE) LLMs is bottlenecked by expensive infrastructure, inefficient evaluation pipelines, scarce training data, and costly quality control._
...
RepoForge tackles all of these with a fully autonomous, end-to-end pipeline. By combining Lineage Image Reuse and Runtime Environment De-bloating, it cuts per-task storage **14× (from 1.4 GB down to 0.102 GB)**. A **Ray**\-**powered**, streaming evaluation harness drives over **70% latency reduction**. The RepoForge Foundry autonomously generates **7,304** validated environments from real GitHub commits with zero manual work. **SPICE** automates labelling at **19,000× lower monetary cos**t than human annotation. Asynchronous Docker execution eliminates pipeline bubbles and delivers a **3× RL speedup**. Altogether, these innovations enable RepoForge-8B-Agent to reach **17.4% on SWE-Bench Verified**, setting a new state of the art for models under 8B parameters.
...
<div align="center">
  ...
  <Small>
    ...
    framework versus SWE‑Bench‑Verified. Left: Per Instance, Right: Single Image
    size distribution
  </Small>
</div>
...
<div align="center">
  ...
  <Small>
    **Figure 7:** In the default SWE‑Bench harness, container images are built
    **one at a time**, in a strictly sequential manner. During evaluation,
    RepoForge pre‑installs all required runtime dependencies for each unique
...
To break through the data wall, we built **RepoForge Foundry**— **a fully autonomous system** that _creates_ **evaluation-ready** SWE environments with minimal human intervention.
...
<div align="center">
  ...
  <Small>
    **Figure 10:** Overview of the RepoForge automated pipeline for dependency
    inference, Docker environment construction, validation, self‑improvement,
...
<div align="center">
  ...
  />
  <Small>
    **Figure 11:** Comparison of the OpenHands server–based runtime versus the
    Docker‐exec–based RepoForge‑OpenHands runtime architectures.
  </Small>
</div>
...
<Muted className="text-muted-foreground/80">
  ...
  of prior work. OpenHands% and RepoForge‑OpenHands% are our own measurements
...
We would also like to thank [Haoxiang Zhang](<[https://haoxianghz.gitlab.io/homepage](https://haoxianghz.gitlab.io/homepage)/>), [Aadi Bhatia](<[https://github.com/Aaditya-Bhatia](https://github.com/Aaditya-Bhatia)>), [Rui Shu](<[https://github.com/rshu](https://github.com/rshu)>), [Kim Kisub](https://github.com/FalconLK), [Alex Yang](<[https://github.com/YMRTZ](https://github.com/YMRTZ)>), [Kirill Vasilevski](<[https://github.com/kirill-vas](https://github.com/kirill-vas)>), [Youssef Esseddiq](<[https://github.com/YoussefEssDS](https://github.com/YoussefEssDS)>), [Yanruo Yang](<[https://github.com/yyanruo](https://github.com/yyanruo)>) for the data preparations.
...
@misc{repoforge2025,
  title = {RepoForge: Training a SOTA Fast-thinking SWE Agent with an End-to-End Data Curation Pipeline Synergizing SFT and RL at Scale},
  author = {Zhilong Chen, Chengzong Zhao, Boyuan Chen, Dayi Lin, Yihao Chen,Arthur Leung, Gopi Krishnan Rajbahadur, Gustavo Oliva, Ahmed Hassan},
  year = {2025},
}
